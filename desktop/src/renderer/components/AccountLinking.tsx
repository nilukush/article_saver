            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white rounded-lg max-w-3xl w-full mx-4 max-h-[80vh] overflow-y-auto">
                    <div className="flex items-center gap-4 p-6 border-b">
                        ...
                        <h2 className="text-2xl font-bold">Article Migration</h2>
                    </div>
                    <AccountMigration />
                </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto">
                ...
                {loading && !currentUser ? (
                    <div className="text-center py-8">
                        ...
                        <p className="mt-2 text-gray-600">Loading linked accounts...</p>
                    </div>
                ) : (
                    <>
                        {/* Current Account */}
                        ...
                        {/* Help Text */}
                        <div className="bg-blue-50 p-4 rounded-lg">
                            <h4 className="font-semibold text-blue-900 mb-2">How Account Linking Works</h4>
